...
def rotate_board(board_name):
    '''allows me to reuse check_win check for wins in columns- there must be a prettier way'''
    new_board = [['_','_','_'],['_','_','_'],['_','_','_']]
    new_board[0][0] = board_name[0][2]
    new_board[0][1] = board_name[1][2]
    new_board[0][2] = board_name[2][2]
    new_board[1][0] = board_name[0][1]
    new_board[1][1] = board_name[1][1]
    new_board[1][2] = board_name[2][1]
    new_board[2][0] = board_name[0][0]
    new_board[2][1] = board_name[1][0]
    new_board[2][2] = board_name[2][0]
    return new_board
...
#       I think I can just use the condition above with rotate_board
#   elif board_name[2][0] == board_name[1][1] and board_name[2][0] == board_name[0][2]:
#       check_winner(board_name[2][0])
    else:
        pass
